 ...
 * @author ASUS
 */
public class BilaLogin extends javax.swing.JFrame {

    /**
     * Creates new form BilaLogin
     */
    public BilaLogin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Register3.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        Register3.setText("REGISTER");
        ...
        jLabel4.setText("Jika Belum Punya Akun Klik Register");

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bila/Gambar WhatsApp 2023-12-20 pukul 21.20.06_806b8745.jpg"))); // NOI18N
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(user1, javax.swing.GroupLayout.DEFAULT_SIZE, 90, Short.MAX_VALUE)
                                    .addComponent(pass1)))
    ...
    private void Register3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Register3ActionPerformed
        BilaRegistrasi rg = new BilaRegistrasi();
        rg.setVisible(true);
        rg.pack();
        rg.setLocation(null);
        rg.setDefaultCloseOperation(BilaRegistrasi.EXIT_ON_CLOSE);
        
    }//GEN-LAST:event_Register3ActionPerformed

    private void LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginActionPerformed
        BilaHome hm = new BilaHome();
        hm.setVisible(true);
        hm.pack();
        hm.setLocation(null);
        hm.setDefaultCloseOperation(BilaRegistrasi.EXIT_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BilaLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
